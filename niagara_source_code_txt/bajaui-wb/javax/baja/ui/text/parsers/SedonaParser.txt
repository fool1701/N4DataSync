 ...
 * @author    Brian Frank       
 * @creation  1 Mar 07
 * @version   $Revision: 11$ $Date: 12/2/08 8:18:50 AM EST$
 * @since     Niagara 3.2
 */
public class SedonaParser
  extends TextParser
{ 
  ...
  {          
    switch(buffer[segmentStart])
    {
      ...
      case 'f':
        ...
        if (isKeyword(seg, "foreach")) return true;
        return false;                    
      case 'g':
      ...
      case 'i':
        ...
        if (isKeyword(seg, "internal")) return true;
        return false;
      case 'l':
      ...
      case 'n':
        ...
        return false;
      case 'o':
        if (isKeyword(seg, "override")) return true;
        return false;
      case 'p':
        if (isKeyword(seg, "private")) return true;
        if (isKeyword(seg, "property")) return true;
      ...
      case 's':
        ...
        return false;
      case 't':
        if (isKeyword(seg, "testonly")) return true;
