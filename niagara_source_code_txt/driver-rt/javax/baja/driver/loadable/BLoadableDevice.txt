...
/**
 * BLoadableDevice models a device with loadable components.
 *
 * @author    Robert Adams
 * @creation  4 Feb 02
 * @version   $Revision: 11$ $Date: 9/12/04 1:43:26 PM EDT$
 * @since     Baja 1.0
 */
@NiagaraType
/*
...
//@formatter:off
/*@ $javax.baja.driver.loadable.BLoadableDevice(3660287553)1.0$ @*/
...
////////////////////////////////////////////////////////////////
  ...
  {
    return ((BLoadableNetwork)getNetwork()).postAsync(r);
  }
