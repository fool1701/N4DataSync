...
/**
 * BajaException is the root exception for checked
 * exceptions in the Baja architecture.
 *
 * @author    Brian Frank
 * @creation  27 Feb 01
 * @version   $Revision: 2$ $Date: 6/13/01 9:34:17 AM EDT$
 * @since     Baja 1.0 
 */
...
////////////////////////////////////////////////////////////////
   ...
   */
  public BajaException(String msg, Throwable cause)
  {  
    super(msg);
    this.cause = cause;
  }
   ...
   */
  public BajaException(Throwable cause)
  {  
    this.cause = cause;
  }
...
////////////////////////////////////////////////////////////////
  ...
  /**
   * Get the nested exception for this BajaException
