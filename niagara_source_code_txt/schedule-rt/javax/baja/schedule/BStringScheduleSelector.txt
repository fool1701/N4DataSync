...
/**
 * BStringScheduleSelector is a component that allows a user to
...
public class BStringScheduleSelector
  extends BAbstractScheduleSelector
  implements BIStatus
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $javax.baja.schedule.BStringScheduleSelector(2286466409)1.0$ @*/
/* Generated Thu Jun 02 14:30:05 EDT 2022 by Slot-o-Matic (c) Tridium, Inc. 2012-2022 */
   ...
   * @see #setIn
   */
  public static final Property in = newProperty(Flags.OPERATOR | Flags.TRANSIENT, new BStatusString("", BStatus.nullStatus), null);
   ...
   * @see #setOut
   */
  public static final Property out = newProperty(Flags.OPERATOR | Flags.READONLY | Flags.TRANSIENT, new BStatusString(), null);
  ...
  public static final Type TYPE = Sys.loadType(BStringScheduleSelector.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  public BStringScheduleSelector()
  {
  }
