...
/**
 * BArcTangent performs the operation out = atan(inA)
 *
 * @author    Dan Giorgis
 * @creation  29 Aug 2001
 * @version   $Revision: 7$ $Date: 3/30/2004 3:41:26 PM$
 * @since     Baja 1.0
 */
@NiagaraType
public class BArcTangent
  extends BUnaryMath
{ 
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.tridium.kitControl.math.BArcTangent(2979906276)1.0$ @*/
/* Generated Wed Jan 05 14:19:30 EST 2022 by Slot-o-Matic (c) Tridium, Inc. 2012-2022 */
  ...
  public static final Type TYPE = Sys.loadType(BArcTangent.class);
