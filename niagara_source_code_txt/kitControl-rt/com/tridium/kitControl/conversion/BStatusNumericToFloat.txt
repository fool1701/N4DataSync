...
/**
 * BStatusNumericToFloat is a component that converts a float to a statusNumeric.
 *
...
public class BStatusNumericToFloat
  extends BStatusValueToValue
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.tridium.kitControl.conversion.BStatusNumericToFloat(2400019497)1.0$ @*/
/* Generated Thu Jun 02 14:30:02 EDT 2022 by Slot-o-Matic (c) Tridium, Inc. 2012-2022 */
   ...
   * @see #setOut
   */
  public static final Property out = newProperty(Flags.TRANSIENT | Flags.READONLY | Flags.SUMMARY, 0.0f, null);

  /**
   * Get the {@code out} property.
   * @see #out
   */
  public float getOut() { return getFloat(out); }

  /**
   * Set the {@code out} property.
   * @see #out
   */
  public void setOut(float v) { setFloat(out, v, null); }
  ...
  public static final Type TYPE = Sys.loadType(BStatusNumericToFloat.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  public void execute()
  {
    setOut( ((BNumber)calculate(getIn())).getFloat());
  }
  ...
  {
    return BFloat.make( getOut() ).toString(cx);
  }
