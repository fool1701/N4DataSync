...
/**
 * BDoubleToStatusNumeric is a component that converts a float to a statusNumeric.
 *
...
public class BDoubleToStatusNumeric
  extends BComponent
  implements BIStatus, BINumeric
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.tridium.kitControl.conversion.BDoubleToStatusNumeric(3950968504)1.0$ @*/
/* Generated Thu Jun 02 14:30:02 EDT 2022 by Slot-o-Matic (c) Tridium, Inc. 2012-2022 */
   ...
   * @see #setIn
   */
  public static final Property in = newProperty(Flags.TRANSIENT | Flags.SUMMARY, 0.0d, null);
  ...
  public static final Type TYPE = Sys.loadType(BDoubleToStatusNumeric.class);
