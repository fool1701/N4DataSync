...
//@formatter:off
/*@ $javax.baja.bacnet.export.BBacnetBinaryWritableDescriptor(285772470)1.0$ @*/
...
////////////////////////////////////////////////////////////////
      ...
      try
      {
        ...
        else
        {
          return new NReadPropertyResult(BBacnetPropertyIdentifier.PRIORITY_ARRAY, ndx,
                                         AsnUtil.toAsnEnumerated(e.getValue() ? 1 : 0));
        }
      }
      catch (Exception e)
      {
    ...
    throws BacnetException
  {
    ...
    try
    {
      ...
      BStatusBoolean bacval = (BStatusBoolean)get(inSlotName).newCopy();
  ...
  public final void doMakeWritable(BValue writable)
  {
    ...
    BStatusBoolean[] bacnetValues = getChildren(BStatusBoolean.class);
