...
/**
 * LessExpression is a boolean expression with two operands.  The expression must evaluate
 * to true if the left operand is less than the right operand.
 *
 * @author John Sublett
 * @creation 01/26/2014
 * @since Niagara 4.0
  ...
  extends ComparisonExpression
{
  ...
  {
    return AstNode.OPERATOR_STR_LESS;
  }
  ...
  /**
   * Returns true if the single value from the left side is less than the single value from right
   ...
   * @return true if the single value from the left side is less than the single value from right
   *   side of the expression
   * @since Niagara 4.9
   */
  @Override
