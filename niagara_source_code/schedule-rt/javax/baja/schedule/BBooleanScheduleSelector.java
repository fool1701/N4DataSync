...
/**
 * BBooleanScheduleSelector is a component that allows a user to
...
public class BBooleanScheduleSelector
  extends BAbstractScheduleSelector
  implements BIStatus, BIBoolean
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $javax.baja.schedule.BBooleanScheduleSelector(3846024328)1.0$ @*/
/* Generated Thu Jun 02 14:30:06 EDT 2022 by Slot-o-Matic (c) Tridium, Inc. 2012-2022 */
   ...
   * @see #setIn
   */
  public static final Property in = newProperty(Flags.OPERATOR | Flags.TRANSIENT, new BStatusBoolean(false, BStatus.nullStatus), null);
   ...
   * @see #setOut
   */
  public static final Property out = newProperty(Flags.OPERATOR | Flags.READONLY | Flags.TRANSIENT, new BStatusBoolean(false), null);
  ...
  public static final Type TYPE = Sys.loadType(BBooleanScheduleSelector.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  public BBooleanScheduleSelector()
  {
  }
