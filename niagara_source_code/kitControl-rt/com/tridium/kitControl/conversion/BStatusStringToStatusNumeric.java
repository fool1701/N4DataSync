...
/**
 * BStatusStringToStatusNumeric is a component that converts a StatusString to a StatusNumeric.
 *
...
public class BStatusStringToStatusNumeric
  extends BComponent
  implements BIStatus, BINumeric
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.tridium.kitControl.conversion.BStatusStringToStatusNumeric(2341745312)1.0$ @*/
/* Generated Thu Jun 02 14:30:02 EDT 2022 by Slot-o-Matic (c) Tridium, Inc. 2012-2022 */
  ...
  public static final Type TYPE = Sys.loadType(BStatusStringToStatusNumeric.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  public BStatusStringToStatusNumeric()
  {
  }
...
/**
  ...
  void calculate()
  {
    workingValue.setValue(Double.NaN);
    workingValue.setStatus(getIn().getStatus());
    Double value = null;
    try {value = Double.valueOf(getIn().getValue().trim()); }
    catch(Exception e) {}
    if(value == null)
    {
      ...
      workingValue.setValue(value.doubleValue());
    setOut(workingValue);
  }
