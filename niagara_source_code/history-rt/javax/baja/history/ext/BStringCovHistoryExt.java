 ...
 */
@NiagaraType
public class BStringCovHistoryExt
  extends BCovHistoryExt
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $javax.baja.history.ext.BStringCovHistoryExt(2979906276)1.0$ @*/
/* Generated Thu Jan 27 19:02:05 CST 2022 by Slot-o-Matic (c) Tridium, Inc. 2012-2022 */
  ...
  public static final Type TYPE = Sys.loadType(BStringCovHistoryExt.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  protected void writeRecord(BAbsTime timestamp, BStatusValue out)
    throws IOException
  {
    append(rec.set(timestamp, ((BStatusString)out).getValue(), out.getStatus()));
  }
