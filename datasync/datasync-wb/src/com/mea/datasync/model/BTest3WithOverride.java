...
/**
 * Test 3: BAbstractDataSource with property override (simple default)
 * Tests if the issue is with property override mechanism
 */
@NiagaraType
@NiagaraProperty(
...
public class BTest3WithOverride extends BAbstractDataSource {

//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.mea.datasync.model.BTest3WithOverride(2018014743)1.0$ @*/
/* Generated Mon Jul 07 07:30:00 AEST 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BTest3WithOverride.class);
...
////////////////////////////////////////////////////////////////
  ...
  public BTest3WithOverride() {
    super();
    System.out.println("🧪 Test3 With Override created");
  }
}
