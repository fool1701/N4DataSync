...
//@formatter:off
/*@ $com.mea.datasync.ui.BDataSyncTool(2985906005)1.0$ @*/
/* Generated Mon Jul 07 05:25:51 AEST 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
   ...
   * @see #setDataSources
   */
  public static final Property dataSources = newProperty(Flags.READONLY | Flags.SUMMARY, new BDataSourceFolder(), null);
...
////////////////////////////////////////////////////////////////
  ...
  public String getNavDescription(Context cx) {
    ...
    if (connections != null) {
      ...
      for (BDataSource conn : allConnections) {
